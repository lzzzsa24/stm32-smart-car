...
| 2 | 原纯四线循迹 |
| 3 | 综合版b32e03a的中线保护循迹＋直接停车观察2秒＋停车朝向优先的圆环出环导航 |
| 4 | 保留原主干 SL2 循迹＋标志导航，不是综合版陀螺仪切线模式4 |
| 5 | 综合版5605916快速循迹＋连续衔接固定绕障：25 cm/30 cm/45°，直行上限4000 CPS、宽线3600 CPS，无需K210 |

模式3更新至 `b32e03a`；模式5更新至 `5605916`。
模式1、2、4保留原主干控制器。
详见 [整合记录](docs/history/candidates/MAIN_MODE35_20260910.md)。
模式5保留固定直行/回线目标4000 CPS，
