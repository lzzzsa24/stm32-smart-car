#ifndef Promoted_SIGN_ROUTE_H
#define Promoted_SIGN_ROUTE_H
...
typedef enum
{
  Promoted_SIGN_ROUTE_IDLE = 0,
  Promoted_SIGN_ROUTE_ARMED,
  Promoted_SIGN_ROUTE_SELECTING,
  Promoted_SIGN_ROUTE_LOCKED,
  Promoted_SIGN_ROUTE_PROBE,
  Promoted_SIGN_ROUTE_WAIT_SIGN,
  Promoted_SIGN_ROUTE_ARC,
  Promoted_SIGN_ROUTE_EXIT_SELECT,
  Promoted_SIGN_ROUTE_EXIT_CLEAR,
  Promoted_SIGN_ROUTE_FAULT,       /* reserved legacy state; no timed line-loss hold */
  Promoted_SIGN_ROUTE_SEARCHING,   /* display-only; search keeps the underlying route phase */
  Promoted_SIGN_ROUTE_CANCELLED,   /* route withdrawn; line controller still runs */
  Promoted_SIGN_ROUTE_ENTRY_RETURN,
  Promoted_SIGN_ROUTE_ENTRY_FALLBACK
} Promoted_SignRouteState;

typedef enum
{
  Promoted_SIGN_ROUTE_PROFILE_STANDARD = 0,
  Promoted_SIGN_ROUTE_PROFILE_GYRO_TANGENT
} Promoted_SignRouteProfile;
...
uint8_t Promoted_SignRoute_GetExitAngleDegrees(void);
...
void Promoted_SignRoute_Step(uint8_t line_mask,
                    uint32_t now,
