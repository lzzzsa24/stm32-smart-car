...
#define IR_REMOTE_VIRTUAL_AUDIO_TOGGLE 6U
#define IR_REMOTE_VIRTUAL_AUDIO_PLAY IR_REMOTE_VIRTUAL_AUDIO_TOGGLE
#define IR_REMOTE_VIRTUAL_AUDIO_ONCE IR_REMOTE_VIRTUAL_AUDIO_TOGGLE
#define IR_REMOTE_VIRTUAL_KEY5      7U
#define IR_REMOTE_VIRTUAL_AUDIO_VOLUME_UP   8U
