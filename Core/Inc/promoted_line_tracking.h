...
#ifndef PROMOTED_LINE_TRACKING_HEADER_H
#define PROMOTED_LINE_TRACKING_HEADER_H

#include <stdint.h>

#define Promoted_LINE_TRACKING_MIDDLE_GUARD_CPS 1800L
...
} Promoted_LineTrackingReading;

typedef enum
{
  Promoted_LINE_ACTION_STOP = 0,
  Promoted_LINE_ACTION_FORWARD,
  Promoted_LINE_ACTION_LEFT_ADJUST,
  Promoted_LINE_ACTION_RIGHT_ADJUST,
  Promoted_LINE_ACTION_LEFT_SHARP,
  Promoted_LINE_ACTION_RIGHT_SHARP,
  Promoted_LINE_ACTION_CROSSING,
  Promoted_LINE_ACTION_SEARCH_LEFT,
  Promoted_LINE_ACTION_SEARCH_RIGHT
} Promoted_LineTrackingAction;
...
/* Mode2 precision profile, also used by mode3's shared line owner.
   While enabled, forward travel is allowed
...
int8_t Promoted_line_tracking_direction_evidence(const Promoted_LineTrackingReading *reading);
...
#endif /* PROMOTED_LINE_TRACKING_HEADER_H */
