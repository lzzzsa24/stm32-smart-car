...
flashed_source_commit: f399de7138e6538e943709600cef505be6fa596b
flash_record_commit: f826140caf8bc019570c7e019d936ec3ce3645e2
deployed_tag: deployed/2026-09-10-f399de7
formal_bin_path: manual-build-unified-motion/exp7_unified_motion.bin
formal_hex_path: manual-build-unified-motion/exp7_unified_motion.hex
formal_bin_size_bytes: 120008
flashed_bin_sha256: DEA054353CE2773F55B44CCE11C6D9318311002A1E7A6EFF7C70E1D4B4DAEA2B
flashed_hex_sha256: 10B1E3184877FE06828146E03F127F6ED8A459B9969A43144B10C39CD08DE972
ground_test_status: not_tested_after_f399de7_deployment
...
user_reported_flash: tool_verified_f399de7_readback_GO
...
stm32_runtime_status: COM11_f399de7_full_readback_GO_no_post_GO_query
k210_requested_deployment: SIGN34_modes3_4_complete_20e8c72
temporary_flash_selector_commit: f399de7_comprehensive_flashed
...
exit. Full sign suite and ARM build passed. COM11 full120008-byte readback
and GO passed. Reserved pages excluded, K210/main code unchanged.
No post-GO query, physical test or push. Evidence:
docs/history/deployments/DEPLOYMENT_F399DE7_20260910.md.
Supersedes older comprehensive candidate and board records below.
...
COM11 full120784-byte write/readback and GO passed. Reserved pages excluded,
K210 unchanged. No post-GO query, physical test or push. Evidence:
docs/history/deployments/DEPLOYMENT_EC15DDA_20260910.md.
Supersedes older unflashed and board-source entries below.
...
COM11 full120784-byte write/readback and GO passed. Reserved pages excluded,
K210 unchanged. No post-GO query, physical test or push. Evidence:
docs/history/deployments/DEPLOYMENT_F1301B2_20260910.md.
Supersedes USB blocker and older unflashed/board entries below.
...
Exact tested artifact passed COM11 full120648-byte write/readback and GO.
Reserved pages excluded, K210 unchanged; no post-GO query or physical test.
Evidence: docs/history/deployments/DEPLOYMENT_55486E6_20260910.md.
Supersedes older unflashed and board-source statements below.
...
b6b4c2c merged: mode3 retains middle+outer feedback during entry selection.
Sign suite, mode1/2/mode5 checks and ARM build passed. COM11 full120236-byte
write/readback and GO passed. Reserved pages excluded, K210/main unchanged.
No post-GO query, physical test or push. Evidence:
docs/history/deployments/DEPLOYMENT_DD0FA57_20260910.md.
Supersedes older comprehensive/board records below.

### Latest comprehensive deployment: b55ab50

249927b merged: mode3 observation22%, mode4 stays26%. Sign suite, mode1/2
andmode5 checks and ARM build passed. COM11 full120216-byte readback and GO
passed. Reserved pages excluded; no post-GO query, physical test or push.
K210/main code unchanged. Evidence:
docs/history/deployments/DEPLOYMENT_B55AB50_20260910.md.
Supersedes older comprehensive/board records below.

### Latest comprehensive deployment: 020e7dd

316747e/c8ca153 integrated: mode5 straight cap3600 CPS; mode3 active exit
advanced15 degrees. Full line/sign suites, mode5 check and ARM build passed.
COM11 full120208-byte write/readback and GO passed, reserved pages excluded.
K210/main code unchanged; no post-GO query, physical test or push.
Evidence: docs/history/deployments/DEPLOYMENT_020E7DD_20260910.md.
Supersedes older comprehensive/board-source records below.
...
COM11 full119440-byte write/readback and GO passed, exit0, before the
interruption. No repeat flash needed. Audio/calibration pages excluded;
K210 unchanged, no post-GO query or physical test. Evidence:
docs/history/deployments/DEPLOYMENT_B32E03A_20260910.md.
This supersedes older board/unflashed candidate statements below.
