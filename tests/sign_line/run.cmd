...
cl /nologo /W4 /WX /utf-8 /std:c11 /ICore\Inc tests\sign_line\test_sign_line.c Core\Src\vision_detection_parser.c Core\Src\simple_line_mode.c Core\Src\sign_route.c /Fomanual-build-sign-line-host-test\ /Femanual-build-sign-line-host-test\test_sign_line.exe
if not "%errorlevel%"=="0" exit /b 1
