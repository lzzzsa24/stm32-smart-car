...
cl /nologo /W4 /WX /utf-8 /std:c11 /Itests\line_recovery\stubs /ICore\Inc tests\gyro_turn\test_gyro_turn.c Core\Src\mpu6050_yaw.c Core\Src\gyro_turn.c Core\Src\line_bypass_turn.c /Fomanual-build-gyro-host-test\ /Femanual-build-gyro-host-test\test_gyro_turn.exe
if not "%errorlevel%"=="0" exit /b 1
