...
cl /nologo /W4 /WX /utf-8 /std:c11 /ICore\Inc tests\dfplayer\test_dfplayer_protocol.c Core\Src\dfplayer_protocol.c Core\Src\ir_remote_keymap.c /Fomanual-build-dfplayer-host-test\ /Femanual-build-dfplayer-host-test\test_dfplayer_protocol.exe
if not "%errorlevel%"=="0" exit /b 1
