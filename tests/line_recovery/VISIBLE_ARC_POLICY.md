...
Historical c5a4c76 policy. Lone-outer targets and recovery audio are superseded
by [EDGE_SLOW_SILENT.md](EDGE_SLOW_SILENT.md); the notes below retain the original
candidate's behavior and validation for comparison.
