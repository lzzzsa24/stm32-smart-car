...
Historical prerequisite (074ef682). The base/deployment notes below describe
that change when prepared. The current combined candidate and updated visible
steering policy are documented in [VISIBLE_ARC_POLICY.md](VISIBLE_ARC_POLICY.md).
